...
public class PokerStarsFlopHandParserAssistant extends HandParserAssistant{
    ...
    @Override
    public void assist(String line, HandDto hand, List<PlayerDto> playerList, PlayerDto player, HandService handService,
                       PlayerService playerService, HashSet<PlayerDto> playerSet, Map<PokerStarsHandBlockName, StringBuilder> stringBuilderMap, List<HandDto> globalHandDtoList,
                       Map<PlayerDto, Void> globalPlayerDtoList, List<Hand> handListGlobal, Map<Player, Void> playerMapGlobal, Set<Player> playerSetAssigned, Set<Hand> handSetAssigned) {
